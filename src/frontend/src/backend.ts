...
export class Backend implements backendInterface {
    ...
    async createPost(arg0: PostPayload): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAllPosts(): Promise<Array<[bigint, PostNonActor]>> {
        if (this.processError) {
            try {
    ...
    async getDraftPosts(): Promise<Array<[bigint, PostNonActor]>> {
        if (this.processError) {
            try {
    ...
    async getPost(arg0: bigint): Promise<PostNonActor> {
        if (this.processError) {
            try {
    ...
    async getPublishedPosts(): Promise<Array<[bigint, PostNonActor]>> {
        if (this.processError) {
            try {
    ...
    async initializeSamplePosts(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeSamplePosts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePost(arg0: bigint, arg1: PostPayload): Promise<void> {
        if (this.processError) {
            try {
